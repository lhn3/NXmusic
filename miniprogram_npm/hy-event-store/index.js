...
__DEFINE__(1645598321099, function(require, module, exports) {
module.exports = {
  HYEventBus: require('./event-bus'),
  HYEventStore: require('./event-store')
}

}, function(modId) {var map = {"./event-bus":1645598321100,"./event-store":1645598321101}; return __REQUIRE__(map[modId], modId); })
__DEFINE__(1645598321100, function(require, module, exports) {
class HYEventBus {
  constructor() {
    this.eventBus = {}
  }
...
__DEFINE__(1645598321101, function(require, module, exports) {
...
}, function(modId) { var map = {"./event-bus":1645598321100,"./utils":1645598321102}; return __REQUIRE__(map[modId], modId); })
__DEFINE__(1645598321102, function(require, module, exports) {
...
return __REQUIRE__(1645598321099);
})()
